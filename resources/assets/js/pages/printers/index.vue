<template>
    <div>
        ...
        <div v-if="dataReady" id="data_table_view">
            <button class="btn-new" @click="$router.push('/printers/create')"><i class="fa fa-plus" aria-hidden="true"></i>New Printer
            </button>
            <div id="printers"></div>
        </div>
    </div>
...
//    import {AwesomeTable} from '../../elements/tables/AwesomeTable';
    ...
    export default {
        ...
        mounted: function () {
            ...
            $.get('/printers', function (response) {
        ...
        methods: {
            renderTable(){
                ...
                $(function(){
                    searchableTable.addTo('printers')
                })
