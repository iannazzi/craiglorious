...
class RoleTest extends ApiTester
{
    ...
    function can_be_updated()
    {
        ...
        $rawContent = '{"data":[{"id":"3","name":"samm","timeout_minutes":"120","ip_address_restrictions":"Add ip addresses separated by ,","relogin_on_ip_address_change":1,"restrict_to_terminal_access":0,"allow_edit_invoice_details":1,"allow_edit_closed_invoice":0,"allow_voids":0,"allow_refunds":1,"max_discount_percent":"10","edit_closed_contents":0,"edit_closed_payments":1,"edit_closed_customer":0,"allow_other_payment":0,"allow_cc_return":0,"allow_advanced_return":0,"open_close_terminal":0,"po_max_open_past_cancel":"10","po_max_received_not_invoiced":"10","active":1,"comments":""}],"_method":"patch"}';
